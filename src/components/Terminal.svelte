<script lang="ts">
    ...
    const commands: {[key: string]: string} = {
        "help": "Supported commands: \nhelp, aboutme, skills, experience, education, contact, github, whotohire",
        "aboutme": "I am passionate software developer and always eager to learn new technologies.",
        "skills": "Languages: Python, Svelte, JavaScript, TypeScript, CSS\nFrameworks: Django, React\nOther: Databricks, Git",
