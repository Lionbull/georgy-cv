...
<div id="terminal-window">
  ...
  <div id="terminal" on:click={focusInput}>
    <div class="introduction-text">
      =======================================<br />
      Welcome to the CV of
      <span class="intext-highlight">Georgy Pokazeev</span>!<br />
      This interactive terminal will provide you all the professional information
      about me.<br />
      You can start with the <span class="intext-highlight">"help"</span>
      command.<br /><br />
      <span class="intext-highlight">NOTE:</span> If you are not much of a
      terminal user, please press the link to a
      <a href="/classic_cv" target="_blank">Classic CV here</a>
      or above the terminal.<br />
      =======================================<br />
    </div>
